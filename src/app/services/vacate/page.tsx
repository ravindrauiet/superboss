...
export default function VacateCleaningPage() {
  ...
  const [selectedService, setSelectedService] = useState('Vacate Cleaning Perth');
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-6 space-y-5">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-brand-50 border border-brand-200 rounded-[8px] text-brand-700 text-xs font-bold">
                  ...
                  Full Property Transformation Guarantee
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed font-normal">
                  Deep vacate cleaning for empty rental homes, units, and houses in Perth. Perfect for move-out bond refunds or preparing a property for new occupants.
                </p>

                <div className="space-y-2.5 pt-1">
                  {[
                    'Complete Top-to-Bottom Vacate Property Deep Clean',
                    'Oven, Rangehood, Dishwasher & Appliance Detailing',
                    'Bathroom Shower Glass, Mirrors & Tile Grout Descaling',
                    '72-Hour Free Reclean Warranty & Official Receipt'
                  ].map((feat, i) => (
                ...
                <div className="pt-3 flex items-center gap-3">
                  <button
                    onClick={() => handleOpenBookingModal('Vacate Cleaning Perth')}
