...
export default function EndOfLeaseCleaningPage() {
  ...
  const [selectedService, setSelectedService] = useState('End of Lease Cleaning Perth');
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-6 space-y-5">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-brand-50 border border-brand-200 rounded-[8px] text-brand-700 text-xs font-bold">
                  ...
                  Real Estate Agency Sign-Off Guaranteed
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-700 leading-relaxed font-normal">
                  Tailored end-of-tenancy cleaning solutions to ensure zero hassle during property handovers. We work directly with Perth property managers to guarantee quick bond release.
                </p>

                <div className="space-y-2.5 pt-1">
                  {[
                    '100% Agency Pass Guarantee with 72h Free Reclean',
                    'Deep Kitchen, Rangehood & Oven Cleaning Included',
                    'Internal Windows, Tracks & Skirting Boards Wiped',
                    'Key Pickup & Dropoff Service Available'
                  ].map((feat, i) => (
                ...
                <div className="pt-3 flex items-center gap-3">
                  <button
                    onClick={() => handleOpenBookingModal('End of Lease Cleaning Perth')}
